function res = SolSistemaEst(Sgo,Sao,Eo,epsilon,phi,mu,Kg,Ka,Ke,omega,gamma,beta,alpha,tE)
...
function res = rate(t,Y,epsilon,phi,mu,Kg,Ka,Ke,omega,gamma,beta,alpha)
    ...
    dSgdt = epsilon * sa * (1 - sg / Kg) - phi * sg - mu * sg;
    dSadt = phi * sg * (1 - sa / Ka) - omega * sa;
