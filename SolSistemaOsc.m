function res = SolSistemaOsc(Sgo,Sao,Eo,epsilon,phi,mu,Kg,Ka,Ke,omega,gamma,beta,alpha,tE)
  ...
  % Obtendo os parâmetros da função 'rate'
    ...
    %plot(T(indice_t), valor_E, 'o', 'MarkerFaceColor', 'p', 'MarkerSize', 4)
    legend('Sg','Sa','E')

    ultimo_E = E(end);

    res.ultimo_E = ultimo_E;
